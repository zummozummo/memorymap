      ...
      <div className={classes.container}>
        ...
        <div className={classes.signup}>
          <div className={classes.heading}>
            {" "}
            <h2 className={classes.text}>Welcome to Memory Map.</h2>{" "}
          </div>
          ...
          <form onSubmit={this.onSubmit}>
            <div className={classes.field}>
              <input
                ...
                value={username}
              />
              <label className={classes.labelField} htmlFor="username">
                Username
              </label>
            </div>
            <div className={classes.field}>
              <input
                ...
                value={email}
              />
              <label className={classes.labelField} htmlFor="email">
                Email
              </label>
            </div>
            <div className={classes.field}>
              ...
              <input
                ...
                value={password}
              />
              <label className={classes.labelField} for="password">
                Password
              </label>
            </div>
